...
class TestStudentSubmitSong(BaseCase):
    ...
    def test_form_flow(self):
        ...
        self.first_el(self.await_id("link")).send_keys(
            "https://musiclab.chromeexperiments.com" "/Song-Maker/song/5577825799634944"
        )
        ...
        all_options = [
            o.get_attribute("value") for o in el.find_elements_by_tag_name("option")
        ]
        ...
        while self.driver.title != "Test Title":
            ...
            if retries > 100:
                self.fail(
                    "Did not successfully navigate to the gallery from "
                    "form success page"
                )
