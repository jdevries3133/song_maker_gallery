...
describe("stage", () => {
  ...
  // TODO: toHaveStyle assertions are broken
  // https://github.com/styled-components/styled-components/issues/3297
  //
  // Restore these texts when they are fixed
  ...
  //     expect(queryByText(`${count}/${TITLE_LENGTH_LIMIT}`)).toHaveStyle(
  //       "display: none;"
  //     );
  //   });
  // });
