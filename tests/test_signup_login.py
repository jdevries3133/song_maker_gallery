...
class TestAuth(BaseCase):
    def test_registration_process(self):
        ...
        self.first_el(self.await_data_testid("usernameInput")).send_keys("myusername")
    ...
    def test_username_login(self):
        ...
        User.objects.create_user(  # type: ignore
            username="myusername", password="passwordgoeshere"
        )
    ...
    def test_email_login(self):
        ...
        self.login("myemail@email.com", "passwordgoeshere")
